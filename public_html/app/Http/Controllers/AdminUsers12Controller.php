<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tel Number","name"=>"tel_number"];
			...
			$this->form[] = ['label'=>'Tel Number','name'=>'tel_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Password Reset Token','name'=>'password_reset_token','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
